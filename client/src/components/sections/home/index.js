...
// import resumePDF from "../../../files/Anshul_Resume_July_2025.pdf"
...
const handleDownloadResume = () => {
  window.open("/assets/files/Anshul_Resume_July_2025.pdf", "_blank")
}
        ...
        <div className="left-grid">
          ...
          <div>
            <h1
              ...
              data-aos-once="true"
            >
              <div className="text1">Anshul </div>
              <div className="text2">Jain</div>
            </h1>
          </div>
          <p
            data-aos="fade-right"
            ...
            data-aos-once="true"
          >
            Highly motivated and very passionate Computer Engineering student
